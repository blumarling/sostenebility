...
const HeroHome = ({ title = '', image = '', image_mobile = '', titleColor = '',
full = '', leftBottomTitle  = '', buttonLabel, isAnchor = false, modalLink = false, buttonLink,}) => {
  ...
  return (
    ...
    >
      ...
      {!!image && <img
        className="h-full w-full left-0 object-cover object-left xl:object-center xl:object-contain hidden md:block absolute hero-pic"
        src={image} alt=""
      />}
      {!!image_mobile && <img
        className="h-full w-full left-0 object-cover object-left absolute hero-pic md:hidden"
